...
const PREVIEW_MESSAGES = [
  {id: 1, content: "Tau ga sih? BTN Development itu anak anaknya pada cakep?!", isSent: false},
  {id: 2, content: "Wah emang iya? Aku baru tau loh", isSent: true},
];
    ...
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">Pilih tema untuk tampilan chat kamu.</p>
        </div>
        ...
        <h3 className="text-lg font-semibold mb-3">Pratinjau</h3>
